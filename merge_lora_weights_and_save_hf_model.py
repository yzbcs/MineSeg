...
def main(args):
    ...
    # Only init SAM + text_hidden_fcs for LLaVA base (no visual_model yet).
    # For LISA models, these are already loaded by from_pretrained.
    ...
    print(f"Loaded weights: {len(state_dict)} keys, "
